...
class AuthService {
  ...
  /// Calls GET {{BaseURL}}datasets/get-pid-datasets/?id={id} and returns
  /// the parsed [PidDataset] on success — the full PID definition list for
  /// a given dataset id (code, resolution, unit, min/max, etc. for each
  /// live parameter).
  ...
  /// Calls GET {{BaseURL}}datasets/get-dtc-datasets/?id={id} and returns
  /// the parsed [DtcDataset] on success — the full DTC code list for a
  /// given dataset id.
