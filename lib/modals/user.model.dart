...
class ProdbudDongle {
    ...
    factory ProdbudDongle.fromJson(Map<String, dynamic> json) => ProdbudDongle(
        ...
        isActive: json["is_active"],
        ecuStation: json["ecu_station"] == null ? [] : List<dynamic>.from(json["ecu_station"]!.map((x) => x)),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "priority": priority,
        "is_active": isActive,
        "ecu_station": ecuStation == null ? [] : List<dynamic>.from(ecuStation!.map((x) => x)),
    };
}
