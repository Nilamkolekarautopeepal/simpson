    ...
    return Scaffold(
      appBar: CommonAppBar(
        ...
        actions: [
          ...
          // ── Dongle status — same dot+label pattern as PLC above.
          // Only shown once ESN/vehicle is resolved (canConnectDongle),
          // since before that there's nothing to connect to yet. Tap
          // to retry immediately instead of waiting for the next
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // NOTE: the "Write IQA" action lives in the main content
          // area (see _buildIqaWriteSection) and only appears once
          // flashing has completed successfully — not here while
          // still scanning through the steps.
        ],
      ),
    );
  }
        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                // Dongle status now lives in the app bar next to the
                // PLC indicator (see build()) — nothing to render here.
                Obx(() {
