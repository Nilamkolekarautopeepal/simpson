...
class HomePageView extends GetView<HomePageController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      // ✅ Lock the entire screen while a flash cycle is running.
      final isFlashing = controller.flashInProgress.value;

      return PopScope(
        // Blocks the Android back gesture/button while flashing.
        canPop: !isFlashing,
        onPopInvokedWithResult: (didPop, result) {
          if (!didPop && isFlashing) {
            Get.snackbar(
              'Flashing in Progress',
              'Please wait until flashing completes.',
              snackPosition: SnackPosition.BOTTOM,
              backgroundColor: _StationColors.amberBg,
              colorText: Colors.white,
            );
          }
        },
        child: AbsorbPointer(
          // ✅ Swallows ALL taps/gestures anywhere below this point —
          // sidebar, ESN field, logout button, PLC/dongle status chips,
          // HIL Setup, API Logs, DTC/PID sections, everything — while
          // flashing is true. Automatically releases the moment
          // flashInProgress flips back to false (success or failure).
          absorbing: isFlashing,
          child: Scaffold(
            appBar: CommonAppBar(
                    ...
                    () => controller.harnessReceipes.isEmpty
                        ...
                        : Container(
                            ...
                            child: Text(
                              ...
                              style: const TextStyle(
                                  fontSize: 11, color: _StationColors.brightGreen),
                            ),
                          ),
                  ),
                ],
                ...
                child: Theme(
                  data: Theme.of(context).copyWith(
                    textSelectionTheme: TextSelectionThemeData(
                      selectionColor: _StationColors.brightGreen.withOpacity(0.4),
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: const OutlineInputBorder(
                        ...
                        borderSide:
                            BorderSide(color: _StationColors.brightGreen, width: 1.5),
                      ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.check_circle, size: 16, color: _StationColors.brightGreen),
              SizedBox(width: 6),
              Text(
                'Resolved from ESN',
                style: TextStyle(
            ...
            Obx(
              () => ClipRRect(
                ...
                child: LinearProgressIndicator(
                  ...
                  valueColor:
                      const AlwaysStoppedAnimation<Color>(_StationColors.brightGreen),
                ),
              ),
            ),
          ],
        ...
        return const Padding(
          ...
          child: Center(
            child: SizedBox(
              width: 20,
              height: 20,
              child: CircularProgressIndicator(strokeWidth: 2, color: _StationColors.brightGreen),
            ),
          ),
        );
      }
                  ...
                  if (trailingLabel != null) ...[
                    ...
                    Container(
                      ...
                      child: Text(
                        trailingLabel,
                        style: const TextStyle(
                            fontSize: 12, color: _StationColors.brightGreen, fontWeight: FontWeight.bold),
                      ),
                    ),
                  ],
                  const Spacer(),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(4),
          border: Border.all(color: selected ? color : Colors.white.withOpacity(0.35)),
        ),
        child: Text(
          tag,
          style: TextStyle(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(
                                fontSize: 12.5, color: _activityLogColor(entry)),
                          ),
                        ),
                      ],
                    ),
          ...
          child: Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'value',
                hintStyle: TextStyle(fontSize: 11, color: Colors.white.withOpacity(0.4)),
              ),
